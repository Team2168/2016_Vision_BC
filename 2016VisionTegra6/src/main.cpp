...
void findTarget(Mat original, Mat thresholded, Target& targets, const ProgParams& params)
{
	...
	line(original, Point(0, 244), Point(FOV_WIDTH_PIX, 244), GREEN, 3);
	line(original, Point(0, 158), Point(FOV_WIDTH_PIX, 158), GREEN, 3);

	line(original, Point(0, 163), Point(FOV_WIDTH_PIX, 163), OFF_COLOR, 3);
	line(original, Point(0, 249), Point(FOV_WIDTH_PIX, 249), OFF_COLOR, 3);
